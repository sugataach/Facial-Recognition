...
training_labels = num2OneOfK(double(tr_labels));
...
[test_set] = classifyFacesMLR(wSoftmax,validation_data,size(validation_labels,2));
validation_labels = oneOfK2Num(validation_labels);
